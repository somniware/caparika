        ...
        <Layout>
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                  <FormLayout>
                    <Controller
                      ...
                      control={control}
                      defaultValue=""
                      render={({ onChange, value }) => <TextField type="text" label="First Name" onChange={onChange} value={value} />}
                    />
                    ...
                    <Controller
                      ...
                      control={control}
                      defaultValue=""
                      render={({ onChange, value }) => <TextField type="text" label="Last Name" onChange={onChange} value={value} />}
                    />
                    ...
                    <Controller
                      ...
                      control={control}
                      //options={options}
                      render={({ onChange, value }) => <Select label="Gender" onChange={onChange} options={options} value={value} />}
                    />
          ...
          <Layout.Section oneHalf>
            <Card title="Products" sectioned>
              <Card.Section>
                <TextStyle variation="subdued">Choose your products please</TextStyle>
              </Card.Section>
              <Card.Section>
                <Scrollable>
                  <ResourceList
